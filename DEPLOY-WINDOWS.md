...
Если все четыре команды находятся — шаг 1 и загрузку NSSM в шаге 7 можно пропустить, переходите сразу к [шагу 2](#2-скачать-проект). NSSM спокойно управляет несколькими независимыми службами одновременно: `nssm install TpgkMaxBot ...` в шаге 7 создаст ещё одну службу рядом с уже существующими, ничего в них не трогая.
